...
public class CompanyService : ICompanyService
{
    ...
    {
        return repository.GetAll().ProjectTo<Companies>(mapper.ConfigurationProvider).ToList();
    }

    public CompanyResponse GetItem(string id)
    {
        return mapper.Map<CompanyResponse>(repository.GetByCode(id));
    }
